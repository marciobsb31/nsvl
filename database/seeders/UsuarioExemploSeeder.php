...
class UsuarioExemploSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // --- 2. Walyson: usuário federal adicional para homologação local ---
        ...
        // --- 5. Carlos Souza: vários vínculos (troca de contexto / histórico) ---
        ...
        // --- 6. Márcio Pereira da Silva (GOV.BR) — mesmos vínculos federais de Maria + contexto federal (última solicitação) ---
        ...
        if ($this->command) {
            ...
            $this->command->table(
                ...
                [
                    ...
                    ['Federal adicional', $walyson->nome, $walyson->email, $walyson->govbr_sub, 'Gestor Nacional'],
                    ...
                    ['GOV.BR (espelho Maria federal)', $marcio->nome, $marcio->email, $marcio->govbr_sub, 'Gestor Nacional (6 perfis)'],
