...
Consulte `.env.example` para referência. As variáveis de ambiente local costumam estar no `docker/docker-compose.yml`.

> **Atenção:** Preencha `GOVBR_CLIENT_ID` e `GOVBR_CLIENT_SECRET` com os valores reais do GOV.BR.

## Documentação Completa

Disponível em [`documentacao/backend/`](../documentacao/backend/):

- [Arquitetura](../documentacao/backend/architecture.md)
- [Autenticação GOV.BR](../documentacao/backend/authentication.md)
- [Anonimização de Dados](../documentacao/backend/anonymization.md)
- [Logs de Auditoria](../documentacao/backend/audit-logs.md)
- [Segurança](../documentacao/backend/security.md)
- [Swagger / OpenAPI](../documentacao/backend/swagger.md)
- [Testes](../documentacao/backend/testing.md)
- [Docker](../documentacao/backend/docker.md)
- [Setup](../documentacao/backend/setup.md)
- [SonarQube](../documentacao/backend/sonarqube.md)
- [Contribuição](../documentacao/backend/contributing.md)